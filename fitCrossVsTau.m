function fitResults = fitCrossVsTau(tbl, initialGuess)
...
%   fitResults = fitCrossVsTau(tbl, initialGuess)
    ...
    [pFit,resnorm,residual,exitflag,output,lambda,J] = ...
        lsqnonlin(residFun, initialGuess, [], [], options);
    ...
    xlabel('\tau');
    ylabel('Cross');
    title('Weighted Least-Squares Fit of Cross vs Tau');
    legend('Data','Fit');
    grid on;
